...
var file_sso_auth_service_proto_rawDesc = []byte{
	...
	,
...
var file_sso_auth_service_proto_depIdxs = []int32{
	6,  // 0: sso.RegisterUserRequest.credentials:type_name -> sso.UserCredentials
	7,  // 1: sso.RegisterUserResponse.user:type_name -> sso.User
	8,  // 2: sso.RegisterUserResponse.access_token:type_name -> sso.Token
	8,  // 3: sso.RegisterUserResponse.refresh_token:type_name -> sso.Token
	6,  // 4: sso.LoginByCredsReq.credentials:type_name -> sso.UserCredentials
	8,  // 5: sso.LoginByCredsRes.access_token:type_name -> sso.Token
	8,  // 6: sso.LoginByCredsRes.refresh_token:type_name -> sso.Token
	8,  // 7: sso.RefreshTokenRes.access_token:type_name -> sso.Token
	...
	1,  // 11: sso.AuthService.RegisterUser:output_type -> sso.RegisterUserResponse
	3,  // 12: sso.AuthService.LoginByCredentials:output_type -> sso.LoginByCredsRes
	5,  // 13: sso.AuthService.RefreshToken:output_type -> sso.RefreshTokenRes
